...
export default function ftpParser(dataEntry: Model<IDataEntryDocument>) {
    return new Promise((resolve, reject) => {
        ...
        getlist(ftp_client).then((data) => {
            ...
            data.forEach(element => {
                promisses.push(get_file_from_ftp(ftp_client, 'onlinedata/' + element.name));
            });
        ...
        function getlist(ftp_client: Client): Promise<ListingElement[]> {
            return new Promise((resolve, reject) => {
